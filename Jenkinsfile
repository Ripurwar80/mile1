      ...
      stage("Git Checkout") {
       ...
       stage("Build Image") {
           steps {
               ...
               sh 'docker build -t aws_demo .'
               sh 'docker tag aws_demo:latest 101000260731.dkr.ecr.eu-west-1.amazonaws.com/aws_demo:latest'
           }
       }
...
//       }
         stage("Terraform Start"){
             steps{
                 ...
                 docker login --username AWS --password $PASS 101000260731.dkr.ecr.eu-west-1.amazonaws.com/aws_demo  
                 docker push 101000260731.dkr.ecr.eu-west-1.amazonaws.com/aws_demo  
                 terraform init
